                    ...
                    <div className="mt-6 pt-6 border-t border-white/10">
                        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                            {securityFeatures.map((item, index) => (
                                <div key={index} className="flex flex-col items-center gap-2 p-3 bg-white/5 border border-white/10 rounded-lg hover:bg-white/10 transition-colors duration-300">
                                    <div className="text-white/60">
                                        {item.icon}
                                    </div>
                                    <span className="text-[10px] text-white/60 uppercase tracking-wide font-medium text-center">
                                        {item.text}
                                    </span>
                                </div>
                            ))}
