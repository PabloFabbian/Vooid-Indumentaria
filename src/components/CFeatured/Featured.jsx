...
const cardData = [
    { imageUrl: 'Card1.webp', title: 'Materiales de calidad confort duradero.', description: 'Nuestras remeras brindan comodidad y durabilidad con materiales premium.' },
    { imageUrl: 'Card2.webp', title: 'Tonos vivos que expresan tu personalidad.', description: 'Elige entre amplia gama de colores vivos para tu personalidad única.' },
            ...
            <div className="container px-5 py-12 mx-auto">
                <div className="flex flex-col text-center w-full mb-10">
                    ...
                    <h1 className="sm:text-4xl text-2xl font-medium title-font mb-4 text-white">
                        Descubrí Calidad y Variedad en las<br /> Vooid Oversize
                    </h1>
                    ...
                    {cardData.map((card, index) => (
                        <div key={index} className="p-4 md:w-1/4 sm:w-1/2 w-full">
                            <div className="px-2 py-3">
                                <img src={card.imageUrl} alt={`Imagen ${index + 1}`} className="mb-6 inline-block" />
