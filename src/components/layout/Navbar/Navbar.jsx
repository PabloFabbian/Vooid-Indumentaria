...
function Navbar() {
  ...
  return (
    <>
      <header className="body-font fixed top-0 z-50 w-full bg-black py-2 text-gray-400">
        <div className="relative flex md:h-10 2xl:h-16 items-center justify-between px-3 py-3">
          ...
          <div className="relative hidden w-full items-center md:flex">
            <div className="absolute left-0 flex items-center">
              <NavigationMenu className="ml-6 flex md:text-sm 2xl:text-base items-center text-stone-100 space-x-10">
                ...
                <Link
                  to="/contact"
                  className="cursor-pointer transition duration-200 hover:text-teal-500"
                >
                  Contacto
                </Link>
                <AboutDropdown />
          ...
          >
            ...
            <NavigationMenu className="flex flex-col items-center text-stone-100 space-y-6">
              <Link
                to="/"
                className="block px-4 py-2 text-xl hover:text-teal-500 transition-colors"
      ...
      {/* Cart Drawer (se renderiza fuera del header) */}
      <CartDrawer />
    </>
  );
}
